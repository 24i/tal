...
require.def(
    "antie/devices/mediaplayer/html5noenterbufferingsentinel",
    [
    ...
    function(HTML5MediaPlayer, Device) {
        ...
        /**
         * Main MediaPlayer implementation for HTML5 devices where enter buffering sentinel causes problems.
         * Use this device modifier if a device implements the HTML5 media playback standard but
         * triggers the enter buffering sentinel unnecessarily because of the device not reporting the correct current time.
         ...
         * @name antie.devices.mediaplayer.HTML5NoEnterBufferingSentinel
         * @class
